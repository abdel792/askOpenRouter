...
addon_info = {
	...
	"addon_description": _("""This add-on allows you to ask questions to the free models available on the on OpenRouter platform.
	...
	# version
	"addon_version": "20260217.0.1",
	# Author(s)
	"addon_author": "Abdel <abdelkrim.bensaid@gmail.com>",
...
import os
pythonSources = [os.path.join("addon", "globalPlugins", "askOpenRouter", "*.py")]
